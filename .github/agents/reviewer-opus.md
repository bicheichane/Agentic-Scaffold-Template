...
4. **Write findings** to `docs/adversarial-review-opus.md` (always overwrite the entire file).
...
### `docs/adversarial-review-opus.md` — Issues Only
...
- the location of the review document (`docs/adversarial-review-opus.md`) for the caller agent to read the details and decide what to act on.
