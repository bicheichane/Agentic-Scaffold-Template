...
4. **Write findings** to `docs/adversarial-review-opus4.6.md` (always overwrite the entire file).
...
### `docs/adversarial-review-opus4.6.md` — Issues Only
...
- the location of the review document (`docs/adversarial-review-opus4.6.md`) for the caller agent to read the details and decide what to act on.
